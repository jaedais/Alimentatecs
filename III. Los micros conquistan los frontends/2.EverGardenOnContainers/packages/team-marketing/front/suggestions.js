...
(function suggestions() {
  ...
  class Suggestions extends HTMLElement {
    ...
    connectedCallback() {
      ...
      console.log('dispatchEvent:suggestions:get');

      window.addEventListener('suggestions:change', (ev) => {
        this.render(ev.detail.suggestions);
        console.log('dispatchEvent:suggestions:change');
      });
    ...
    select(product) {
      ...
      console.log('dispatchEvent:suggestions:select');
    ...
    gettemplateproduct(p) {
      return `    
        <figure class="itemside">
            <div class="aside"><img src="/common/images/items/${p.id}.jpg" class="img-sm"></div>
