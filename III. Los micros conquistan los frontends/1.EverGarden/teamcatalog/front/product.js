    ...
    class Product extends HTMLElement {
        ...
        constructor() {
            ...
            window.addEventListener('suggestions:select', (ev) => {
                this.render(ev.detail.product);
                console.log('addEventListener:suggestions:select' , ev.detail.product);
            });
                    ...
                    <aside class="col-sm-6 border-right">
                        <article class="gallery-wrap">
                            <div class="img-big-wrap">
                                <div> <a href="#"><img src="teamorchestrator/front/images/items/${p.id}.jpg"></a></div>
                            </div> <!-- slider-product.// -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                    <dl class="dlist-inline">
                                        <dt>&nbsp;</dt>
                                        <dd>
                                            <wc-btn-buy product_id=${p.id}></wc-btn-buy>
                                        </dd>
                                    </dl> <!-- item-property .// -->
                                </div> <!-- col.// -->
                            </div> <!-- row.// -->
